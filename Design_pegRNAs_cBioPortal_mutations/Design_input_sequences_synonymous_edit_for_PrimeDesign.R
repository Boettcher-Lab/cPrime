...
# function to generate synonymous edit and synonymous marker
...
## create input list for PrimeDesign 
        ...
        if(codon == "ATG" | codon == "TGG" | codon == "TGA" | codon == "TAA" | codon == "TAG"){
          ...
          if(right_distance >= 3){
            ...
            if(marker_codon != "ATG" && marker_codon != "TGG" && marker_codon != "TGA" && marker_codon != "TAA" && marker_codon != "TAG"){
              ...
              str_sub(exon_edit, marker_edit_pos + count_char_edit - 1, marker_edit_pos + count_char_edit - 1) <- marker_edit
              count_char_marker_edit <- nchar(marker_edit)
              start_position_long <- edit_pos-300
              end_position_long <- marker_codon_end+300+count_char_edit-1+count_char_marker_edit-1
              ...
              if(left_distance >= 5){
                ...
                if(marker_codon != "ATG" && marker_codon != "TGG" && marker_codon != "TGA" && marker_codon != "TAA" && marker_codon != "TAG"){
                  ...
                  start_position_long <- marker_codon_start-300
                  end_position_long <- edit_pos+300+count_char_edit-1+count_char_marker_edit-count_char_marker_ref
                  exon_edit <- substr(exon_edit, start_position_long, end_position_long)
                  t=t+1
                  codon_counter = codon_counter + 1
                  input_list_control[t,1] <- paste0("Synonymous_edit_", edit_pos)
          ...
          if(codon == "ATG" | codon == "TGG" | codon == "TGA" | codon == "TAA" | codon == "TAG"){
            ...
            if(right_distance >= 3){
              ...
              if(marker_codon != "ATG" && marker_codon != "TGG" && marker_codon != "TGA" && marker_codon != "TAA" && marker_codon != "TAG"){
                ...
                count_char_marker_ref <- nchar(marker_ref)
                start_position_long <- edit_pos-300
                end_position_long <- marker_codon_end+300+count_char_edit-1+count_char_marker_edit-count_char_marker_ref
                exon_edit <- substr(exon_edit, start_position_long, end_position_long)
                t=t+1
                codon_counter = codon_counter + 1
                input_list_control[t,1] <- paste0("Synonymous_edit_", edit_pos)
          ...
          if(codon == "ATG" | codon == "TGG" | codon == "TGA" | codon == "TAA" | codon == "TAG"){
            ...
            if(right_distance >= 3){
              ...
              if(marker_codon != "ATG" && marker_codon != "TGG" && marker_codon != "TGA" && marker_codon != "TAA" && marker_codon != "TAG"){
                ...
                t = t+1
                codon_counter = codon_counter + 1
                input_list_control[t,1] <- paste0("edit_pos_", edit_pos)
                input_list_control[t,2] <- paste0("codon_pos_", codon_counter)
                input_list_control[t,3] <- "Synonymous"
                input_list_control[t,4] <- text
              }
...
write_xlsx(exon27_control, "Exon_27_PrimeDesign_Input_synonymous_edit.xlsx") 