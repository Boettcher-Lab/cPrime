...
#write_xlsx(input_list, "WT_sequences_stop_gDNA.xlsx") 
...
#write_xlsx(input_list_control, "WT_sequences_synonymous_edit_gDNA.xlsx") 

input_searching <- rbind(input_list[,c(1,3,5)], input_list_control[,c(1,3,5)])
write_xlsx(input_searching, "WT_sequences_stop_and_synonymous_edit_gDNA.xlsx")
