...
## create input list for searching sequences for additional nonsense mutations
...
#write_xlsx(input_list, "Searching_sequences_stop_cDNA.xlsx") 
...
#write_xlsx(input_list_control, "Searching_sequences_synonymous_edit_cDNA.xlsx") 

input_searching <- rbind(input_list[,c(1,3,5)], input_list_control[,c(1,3,5)])
write_xlsx(input_searching, "Searching_sequences_stop_and_synonymous_edit_cDNA.xlsx")
