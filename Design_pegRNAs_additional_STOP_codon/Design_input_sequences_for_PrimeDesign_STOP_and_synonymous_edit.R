    ...
    if(codon %in% check_pos1){
      ...
      if(codon_after <= 574){
        ...
        if(codon_for_synonym_mut != "ATG" & codon_for_synonym_mut != "TGG" & codon_for_synonym_mut != "TGA" & codon_for_synonym_mut != "TAA" & codon_for_synonym_mut != "TAG"){
          ...
          edit_synonym <- str_c("(", ref_synonym, "/", var_synonym ,")")
          ...
          exon_edit_subseq <- str_sub(exon_edit_subseq, nt_1 - 300, nt_1 + count_char_edit + 4 + count_char_edit_synonym -1 + 300)
          t = t+1
          ...
          if(codon_before >= 363){
            ...
            if(codon_for_synonym_mut != "ATG" & codon_for_synonym_mut != "TGG" & codon_for_synonym_mut != "TGA" & codon_for_synonym_mut != "TAA" & codon_for_synonym_mut != "TAG"){
              ...
              exon_edit_subseq <- str_sub(exon_edit_subseq, nt_1 - count_char_edit_synonym - 300, nt_1 + count_char_edit + 300)
              t = t+1
              input_list[t,1] <- paste0("STOP_", edit_pos_genome)
              input_list[t,2] <- paste0("nucleotide_pos_", edit_pos)
              input_list[t,3] <- codon_counter
      ...
      if(codon_after <= 574){
        ...
        if(codon_for_synonym_mut != "ATG" & codon_for_synonym_mut != "TGG" & codon_for_synonym_mut != "TGA" & codon_for_synonym_mut != "TAA" & codon_for_synonym_mut != "TAG"){
          ...
          exon_edit_subseq <- str_sub(exon_edit_subseq, nt_2 - 300, nt_2 + count_char_edit + 3 + count_char_edit_synonym -1 + 300)
          t = t+1
          input_list[t,1] <- paste0("STOP_", edit_pos_genome)
          input_list[t,2] <- paste0("nucleotide_pos_", edit_pos)
          input_list[t,3] <- codon_counter
          ...
          if(codon_before >= 363){
            ...
            if(codon_for_synonym_mut != "ATG" | codon_for_synonym_mut != "TGG" | codon_for_synonym_mut != "TGA" | codon_for_synonym_mut != "TAA" | codon_for_synonym_mut != "TAG"){
              ...
              count_char_edit_synonym <- nchar(edit_synonym)
              str_sub(exon_edit_subseq, nt_1 - 1, nt_1 -1) <- edit_synonym
              exon_edit_subseq <- str_sub(exon_edit_subseq, nt_1 - count_char_edit_synonym - 300, nt_2 + count_char_edit + 300)
              t = t+1
              input_list[t,1] <- paste0("STOP_", edit_pos_genome)
              input_list[t,2] <- paste0("nucleotide_pos_", edit_pos)
              input_list[t,3] <- codon_counter
      ...
      if(codon_after <= 574){
        ...
        if(codon_for_synonym_mut != "ATG" & codon_for_synonym_mut != "TGG" & codon_for_synonym_mut != "TGA" & codon_for_synonym_mut != "TAA" & codon_for_synonym_mut != "TAG"){
          ...
          exon_edit_subseq <- str_sub(exon_edit_subseq, nt_3 - 300, nt_3 + count_char_edit + 2 + count_char_edit_synonym -1 + 300)
          t = t+1
          input_list[t,1] <- paste0("STOP_", edit_pos_genome)
          input_list[t,2] <- paste0("nucleotide_pos_", edit_pos)
          input_list[t,3] <- codon_counter
        ...
        if(codon_for_synonym_mut != "ATG" & codon_for_synonym_mut != "TGG" & codon_for_synonym_mut != "TGA" & codon_for_synonym_mut != "TAA" & codon_for_synonym_mut != "TAG"){
          ...
          count_char_edit_synonym <- nchar(edit_synonym)
          str_sub(exon_edit_subseq, nt_1 - 1, nt_1 -1) <- edit_synonym
          exon_edit_subseq <- str_sub(exon_edit_subseq, nt_1 - count_char_edit_synonym - 300, nt_3 + count_char_edit + 300)
          t = t+1
          input_list[t,1] <- paste0("STOP_", edit_pos_genome)
          input_list[t,2] <- paste0("nucleotide_pos_", edit_pos)
          input_list[t,3] <- codon_counter
...
#write_xlsx(input_list, "Exon_27_PrimeDesign_Input_stop.xlsx") 
...
#write_xlsx(input_list_control, "Exon_27_PrimeDesign_Input_control.xlsx") 

input_primeDesign <- rbind(input_list[,c(1,3,5)], input_list_control[,c(1,3,5)])
write_xlsx(input_primeDesign, "Input_PrimeDesign_stop_and_synonymous_edit.xlsx")
